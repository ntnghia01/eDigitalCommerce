...
import { fetchAvailableProductsDESC, getProductMostSold } from "../../../slices/productSlice";
...
export default function ProductMostSold() {
  ...
  const products = useSelector((state) => state.product.productMostSold);
    ...
    <>
      <Box sx={{ flexGrow: 1, marginBottom: 2, marginTop: 3}}>
        ...
        <Grid
          ...
          style={{ paddingLeft: 0 }}
        >
            <Typography variant="h4" sx={{textAlign: 'center', margin: 3}}>Bán chạy nhất</Typography>
