...
import { searchCustomerAccount, searchShipperAccount } from "../../../../slices/accountSlice";
...
export default function FilterShipperAccountTable() {
  ...
  const changeSearchData = (e) => {
    ...
    dispatch(searchShipperAccount(searchData));
  };
