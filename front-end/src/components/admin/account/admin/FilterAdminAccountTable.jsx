...
import { searchAdminAccount, searchCustomerAccount } from "../../../../slices/accountSlice";
...
export default function FilterAdminAccountTable() {
  ...
  const changeSearchData = (e) => {
    ...
    dispatch(searchAdminAccount(searchData));
  };
