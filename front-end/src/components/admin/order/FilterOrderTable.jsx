...
import { searchOrderByUserName } from "../../../slices/orderSlice";

// import Component

// example data

export default function FilterOrderTable() {
  const dispatch = useDispatch();

  const changeSearchData = (e) => {
    e.preventdefault;
    console.log(e.target.value);
    const searchData = { orderName: e.target.value };
    dispatch(searchOrderByUserName(searchData));
  };
  return (
    <>
      <Grid
      ...
      >
        <Grid item xs={9} md={10}>
          ...
          >
            ...
            <Box sx={{ minWidth: 150 }}>
              <FormControl fullWidth size="small">
                <InputLabel id="demo-simple-select-label">Tổng tiền</InputLabel>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  value={""}
            ...
            <Box sx={{ minWidth: 150 }}>
              <FormControl fullWidth size="small">
                <InputLabel id="demo-simple-select-label">Thanh toán</InputLabel>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  value={""}
