...
export default function ConfirmContactComponent(props) {
  ...
  return (
    <div>
      <Button variant="contained" startIcon={<RecommendIcon />} onClick={handleClickOpen}>
        Xác nhận
      </Button>
      <Dialog
        open={open}
      ...
      >
        <DialogTitle>{"Xác nhận đã đọc liên hệ"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            Bạn có chắc muốn xác nhận đã đọc liên hệ này #{contact.contactId} này?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
