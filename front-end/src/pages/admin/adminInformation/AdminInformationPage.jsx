...
import EditAdminInformationComponent from "../../../components/admin/information/EditAdminInformationComponent";
...
export default function AdminInformationPage() {
  ...
  useEffect(() => {
    dispatch(getCustomerInfo(localStorage.getItem("adminID")));
  }, [dispatch]);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(uploadAvatar({userId: localStorage.getItem("adminID"), avatarData: avatarData}))
      .then(() => {
        dispatch(getCustomerInfo(localStorage.getItem("adminID")));
  ...
  return (
    ...
    <Paper sx={{marginTop: 3, padding: 3}}>
      ...
      >
        ...
        <EditAdminInformationComponent informations={informations} />
